        ...
        <Box sx={{ flexGrow: 1, p: 3, overflowY: 'auto' }}>
          ...
          <Grid container spacing={3}>
            {filteredItems.length > 0 ? (
              ...
              <Grid item xs={12}>
                <Typography sx={{textAlign:'center', color:'black'}}>No items found. Try a different search term or category.</Typography>
              </Grid>
            )}
          </Grid>
        </Box>
          ...
          <>
            ...
            <DialogContent>
              ...
              <Box sx={{ display: 'flex', alignItems: 'center', mt: 2 }}>
                ...
                <IconButton onClick={() => setItemQuantity(Math.min(selectedItem.quantityAvailable, itemQuantity + 1))}>
                  <AddIcon />
                </IconButton>
              </Box>
            </DialogContent>
